        ...
        body: Padding(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                Text(
                  "Zrobilem to na odpierdol, czego sie spodziewales?",
                ...
                Text(
                  "Nimiejszy program został stworzony dla ludzi będącymi fanami produkcji Kapitana Bomby od "
                  ...
                  "nie pozywała nas do sądu",
                  style: TextStyle(fontSize: 20, color: Colors.red.shade400),
                ),
                Text(
                  "Wszelkie uwagi, oferty pomocy, zgłoszenia bugów proszę kierować na:",
                  style: TextStyle(fontSize: 20, color: Colors.red.shade400),
                ),
                Text(
                  "email: kzoladziejewski@gmail.com",
                  style: TextStyle(fontSize: 20, color: Colors.blue.shade400),
                ),
                Text(
                  "albo grupę na facebooku",
                  style: TextStyle(fontSize: 20, color: Colors.red.shade400),
                ),
                IconButton(
                    icon: Icon(Icons.accessible_sharp), onPressed: _launchURL)
              ],
            ),
          ),
        ));
